package com.pig4cloud.pig.workflow.api.config;
...
public class FlowableConfig implements EngineConfigurationConfigurer<SpringProcessEngineConfiguration> {
    ...
    @Value("${spring.datasource.dynamic.datasource.pig_workflow.url}")
    private String jdbcUrl;

    @Value("${spring.datasource.dynamic.datasource.pig_workflow.driver-class-name}")
    private String driverClassName;

    @Value("${spring.datasource.dynamic.datasource.pig_workflow.username}")
    private String username;

    @Value("${spring.datasource.dynamic.datasource.pig_workflow.password}")
