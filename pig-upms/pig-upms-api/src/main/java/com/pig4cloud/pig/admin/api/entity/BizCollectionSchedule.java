...
public class BizCollectionSchedule extends Model<BizCollectionSchedule> {
	...
	@ExcelProperty(value = "收款日期", converter = TimestampStringConverter.class)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonDeserialize(using = SqlTimestampDeserializer.class)
	@ExcelProperty(value = "收款开始时间", converter = TimestampStringConverter.class)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonDeserialize(using = SqlTimestampDeserializer.class)
	@ExcelProperty(value = "收款结束时间", converter = TimestampStringConverter.class)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonDeserialize(using = SqlTimestampDeserializer.class)
	@ExcelProperty(value = "入款时间", converter = TimestampStringConverter.class)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonDeserialize(using = SqlTimestampDeserializer.class)
	@ExcelProperty(value = "审核时间", converter = TimestampStringConverter.class)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonDeserialize(using = SqlTimestampDeserializer.class)
	@ExcelProperty(value = "创建时间", converter = TimestampStringConverter.class)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonDeserialize(using = SqlTimestampDeserializer.class)
	@ExcelProperty(value = "修改时间", converter = TimestampStringConverter.class)
